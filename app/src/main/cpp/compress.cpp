 ...
 */
JNIEXPORT jint JNICALL Java_com_yunkahui_datacubeper_common_utils_ImageCompress_compress
        (JNIEnv * env, jclass clazz, jobject bitmap, jint quality, jstring dstFile,jboolean optimize){

    LOGE("%s", "===>Java_com_yunkahui_datacubeper_common_utils_ImageCompress_compress");
    int ret;
