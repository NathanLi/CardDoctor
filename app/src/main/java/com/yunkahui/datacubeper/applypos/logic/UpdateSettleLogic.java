...
public class UpdateSettleLogic {
     ...
     * 修改结算信息
     */
    public void updataSettleData(Context context, String cardNumber, String bankName, String branch, String province, String city, String branchNumber, String url, SimpleCallBack<BaseBean> callBack){
