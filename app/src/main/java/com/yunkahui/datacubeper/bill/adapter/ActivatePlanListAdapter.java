...
public class ActivatePlanListAdapter extends BaseQuickAdapter<ActivatePlan.Plan,BaseViewHolder> {

    public ActivatePlanListAdapter(int layoutResId, @Nullable List<ActivatePlan.Plan> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ActivatePlan.Plan item) {
