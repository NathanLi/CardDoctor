...
public class BillSynchronousLogic {
    ...
    public static int[] judgeBank(String bankName) {
        ...
        bankList.add(new Bank(new int[]{BillSynchronousActivity.TYPE_PHONE, BillSynchronousActivity.TYPE_USER, BillSynchronousActivity.TYPE_ID_CARD}, new String[]{"中国工商银行", "工商银行", "工行", "工商"}));
