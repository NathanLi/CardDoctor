...
public class DataUtils {
    ...
    public static Integer getBankIconForName(String name) {
        if (getBankIconMap().get(name) == null) {
            return R.mipmap.bank_other;
        } else {
            return getBankIconMap().get(name);
        }
    }
    ...
    public static Map<String, Integer> getBankIconMap() {
        if (bankIconMap == null) {
            ...
            String[] bankNames = new String[]{
                    ...
                    "青海银行", "上海农商银行", "上海浦东发展银行", "浦东发展银行", "上海银行", "台州银行",
            ...
            int[] bankPics = new int[]{
                    ...
                    R.mipmap.bank_qinghai, R.mipmap.bank_shanghainongshang, R.mipmap.bank_shanghaipufa, R.mipmap.bank_shanghaipufa, R.mipmap.bank_shanghai, R.mipmap.bank_taizhou,
