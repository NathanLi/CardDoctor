...
public class PagingScrollHelper {
    ...
    //设置指示器
    public void setIndicator(Context context, RadioGroup radioGroup, int size, int resId) {
        mRadioGroupIndicator = radioGroup;
        mRadioGroupIndicator.setOrientation(LinearLayout.HORIZONTAL);
        mRadioGroupIndicator.setGravity(Gravity.CENTER);
        ...
        for (int i = 0; i < size; i++) {
            ...
            radioButton.setButtonDrawable(resId);
            mRadioGroupIndicator.addView(radioButton);
        }
        if (size > 0)
            mRadioGroupIndicator.check(0);
    }
                ...
                mAnimator.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        if (null != mOnPageChangeListener) {
                            ...
                            if (mRadioGroupIndicator != null) {
                                mRadioGroupIndicator.check(getPageIndex());
                            }
                        }
                    }
                });
    ...
    private int getPageIndex() {
        ...
        if (mOrientation == ORIENTATION.VERTICAL) {
            ...
            LogUtils.e("offsetX = " + offsetX + "  getWidth = " + mRecyclerView.getWidth());
        }
        return p;
    }
