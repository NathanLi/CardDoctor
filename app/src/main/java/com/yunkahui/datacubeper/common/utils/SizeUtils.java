...
public class SizeUtils {
    ...
    public static DisplayMetrics screenSize() {
        DisplayMetrics displayMetrics = CardDoctorApplication.getContext().getResources().getDisplayMetrics();
    ...
    public static int transRatio(float width, float base) {
        DisplayMetrics dm = CardDoctorApplication.getContext().getResources().getDisplayMetrics();
