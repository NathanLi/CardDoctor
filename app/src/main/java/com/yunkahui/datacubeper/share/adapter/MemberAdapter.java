...
public class MemberAdapter extends BaseQuickAdapter<Member.MemberBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, Member.MemberBean item) {
