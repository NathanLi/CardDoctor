...
public class PayVipLogic {
     ...
     * 获取可支持的支付信息
     */
    public void updatePayInfo(Context context,SimpleCallBack<JsonObject> callBack){
     ...
     * 使用激活码升级
     */
    public void updateVipByActivateCode(Context context,String code,SimpleCallBack<JsonObject> callBack){
        Map<String,String> params= RequestUtils.newParams(context)
